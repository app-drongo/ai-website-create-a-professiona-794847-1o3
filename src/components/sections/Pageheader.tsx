      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Comprehensive SAP integration and digital transformation services designed specifically for 
            manufacturing leaders. From strategy to implementation, we deliver solutions that drive 
            operational excellence and competitive advantage in today's digital manufacturing landscape.
          </p>
        </div>
      </div>
    </section>
